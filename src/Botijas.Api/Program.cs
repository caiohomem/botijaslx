...
builder.Services.AddScoped<Botijas.Application.Customers.Commands.UpdateCustomerNameCommandHandler>();
...
builder.Services.AddScoped<Botijas.Application.Orders.Commands.CloseIntakeCommandHandler>();
...
builder.Services.AddScoped<Botijas.Application.Orders.Commands.DeleteEmptyOpenOrderCommandHandler>();
...
builder.Services.AddScoped<Botijas.Application.Business.Queries.IBusinessOverviewQuery, Botijas.Infrastructure.Queries.BusinessOverviewQuery>();
...
builder.Services.AddScoped<Botijas.Application.Tracking.Queries.GetOrderStatusByPhoneQueryHandler>();
